...
IncludeJavaScript('static/javascripts/slides.jquery.js');
IncludeJavaScript('static/javascripts/swfobject.js');
IncludeJavaScript('static/javascripts/jquery.slider.js');
IncludeJavaScript('static/javascripts/jquery.prettyPhoto.js');
IncludeJavaScript('static/javascripts/form.validation.js');
...
(function($) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      ...
      template: "{time}{text}",   // [string or function] template used to construct each tweet <li> - see code for available vars
    ...
    return this.each(function(i, widget){
      var list = $('<ul class="widget-list twitter">').appendTo(widget);
      ...
      $(widget).bind("load", function(){
        $.getJSON(build_url(), function(data){
          ...
          var tweets = $.map(data.results || data, function(item){
            ...
            var time = '<span class="widget-twitter-time"><a href="'+tweet_url+'" title="view tweet on twitter">'+tweet_relative_time+'</a></span><br />';
            var text = '<span class="tweet_text">'+$([tweet_text]).makeHeart().capAwesome().capEpic()[0]+ '</span>';

            return { item: item,time: time,text: text};
          });
